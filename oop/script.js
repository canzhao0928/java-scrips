...
// Car.prototype.accelerate = function () { this.speed += 10; console.log(this.speed); }

// Car.prototype.brake = function () { this.speed -= 10; console.log(this.speed); }
...
class Car {
    ...
    set speedUS(speedUS) { this.speed = speedUS * 1.6 }
}
